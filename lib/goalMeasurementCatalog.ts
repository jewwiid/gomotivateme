...
const CATALOG: Record<string, GoalMeasurementMetric[]> = {
  ...
  career: [
    metric("career", { id: "career.github-commits", label: "GitHub commits", description: "Track verified commits from linked GitHub repositories.", progressType: "number", icon: "count", units: ["commits"], defaultUnit: "commits", directions: ["increase"], defaultDirection: "increase", defaultStartValue: 0, suggestedTargetValue: 50 }),
    metric("career", { id: "career.github-pull-requests", label: "Merged pull requests", description: "Track verified merged pull requests from linked GitHub repositories.", progressType: "number", icon: "count", units: ["pull requests"], defaultUnit: "pull requests", directions: ["increase"], defaultDirection: "increase", defaultStartValue: 0, suggestedTargetValue: 10 }),
  ...
  launch: [
    metric("launch", { id: "launch.github-commits", label: "GitHub commits", description: "Track verified implementation progress from linked GitHub repositories.", progressType: "number", icon: "count", units: ["commits"], defaultUnit: "commits", directions: ["increase"], defaultDirection: "increase", defaultStartValue: 0, suggestedTargetValue: 50 }),
    metric("launch", { id: "launch.github-pull-requests", label: "Merged pull requests", description: "Track verified merged pull requests for the launch.", progressType: "number", icon: "count", units: ["pull requests"], defaultUnit: "pull requests", directions: ["increase"], defaultDirection: "increase", defaultStartValue: 0, suggestedTargetValue: 10 }),
  ...
  creative: [
    metric("creative", { id: "creative.github-commits", label: "GitHub commits", description: "Track verified repository changes for a creative or software project.", progressType: "number", icon: "count", units: ["commits"], defaultUnit: "commits", directions: ["increase"], defaultDirection: "increase", defaultStartValue: 0, suggestedTargetValue: 30 }),
